...
//    private Texture textTexture;
    ...
    public GameScene() {
        ...
        // original 0.93f
        mBtnRotate = new Sprite(sSceneWidth * 0.88f, sSceneHeight * 0.4f, btnSize, btnSize);
        ...
        // original 0.9f
        mNext = new Sprite(sSceneWidth * 0.85f, sSceneHeight * 0.1f, btnSize * 1.2f, btnSize*1.2f); 
